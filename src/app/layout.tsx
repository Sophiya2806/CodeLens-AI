...
export const metadata: Metadata = {
  title: 'CodeLens AI - Intelligent Code Review Assistant',
  description: 'AI-powered security audits, static analysis, and code quality assessments for modern developers.',
};
